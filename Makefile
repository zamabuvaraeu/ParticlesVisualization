...
OUTPUT_FILE_NAME_CONSOLE=ParticlesVisualization$(FILE_SUFFIX_CONSOLE).exe
OUTPUT_FILE_NAME_GUI=ParticlesVisualization$(FILE_SUFFIX_GUI).exe
...
OBJECTFILES_RELEASE_GUI_MODULES=    $(OBJ_RELEASE_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o     $(OBJ_RELEASE_DIR)\InputDataDialogProc$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplayError$(FILE_SUFFIX_GUI).o     
OBJECTFILES_DEBUG_GUI_MODULES=      $(OBJ_DEBUG_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o       $(OBJ_DEBUG_DIR)\InputDataDialogProc$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplayError$(FILE_SUFFIX_GUI).o       
...
$(OBJ_RELEASE_DIR)\WinMain$(FILE_SUFFIX_GUI).c: Modules\WinMain.bas Forms\InputDataDialogProc.bi Resources.RH Modules\DisplayError.bi Forms\DirectXWindowWndProc.bi
...
$(OBJ_DEBUG_DIR)\WinMain$(FILE_SUFFIX_GUI).c:   Modules\WinMain.bas Forms\InputDataDialogProc.bi Resources.RH Modules\DisplayError.bi Forms\DirectXWindowWndProc.bi
...
$(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).o: $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm
	$(GCC_ASSEMBLER) $(GCC_ASSEMBLER_PARAMETERS_RELEASE) $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm -o $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).o

$(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).o:   $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm
	$(GCC_ASSEMBLER) $(GCC_ASSEMBLER_PARAMETERS_DEBUG) $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm -o $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).o

$(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm: $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_RELEASE) $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c -o $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm

$(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm:   $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_DEBUG) $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c -o $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).asm

$(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c: Forms\DirectXWindowWndProc.bas Forms\DirectXWindowWndProc.bi Modules\DisplayError.bi Resources.RH
	$(FREEBASIC_COMPILER) $(FREEBASIC_PARAMETERS_RELEASE_GUI) "Forms\DirectXWindowWndProc.bas"
	move /y Forms\DirectXWindowWndProc.c $(OBJ_RELEASE_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c

$(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c:   Forms\DirectXWindowWndProc.bas Forms\DirectXWindowWndProc.bi Modules\DisplayError.bi Resources.RH
	$(FREEBASIC_COMPILER) $(FREEBASIC_PARAMETERS_DEBUG_GUI) "Forms\DirectXWindowWndProc.bas"
	move /y Forms\DirectXWindowWndProc.c $(OBJ_DEBUG_DIR)\DirectXWindowWndProc$(FILE_SUFFIX_GUI).c
...
$(OBJ_RELEASE_DIR)\Resources$(FILE_SUFFIX_BASE).obj: Resources.RC Resources.RH ParticlesVisualization.exe.manifest icon.ico
...
$(OBJ_DEBUG_DIR)\Resources$(FILE_SUFFIX_BASE).obj: Resources.RC Resources.RH ParticlesVisualization.exe.manifest icon.ico
